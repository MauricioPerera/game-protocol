...
> fallback— es lo reutilizable. Los cruces con el motor (`solid-sync`, `dead-token`) son **opcionales**:
> se activan con la variable de entorno `GAME_ENGINE=<ruta al archivo del motor>`.
