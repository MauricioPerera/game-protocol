...
(tokens + doc)         (compila)            (window.GAME)                (consume con fallback)
   ↑
game-lint.js (valida 133 reglas + cruces opcionales con el motor)
```
...
| Ruta | Rol |
|---|---|
| [`SPEC.md`](./SPEC.md) | **La especificación del protocolo** (formato, tokens, artefacto, 133 reglas — core §4 + perfiles §6; hints de arreglo en [`tools/rule-hints.js`](./tools/rule-hints.js) —, frontera datos/código). |
